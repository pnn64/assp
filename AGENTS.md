...
`assp` is the x86-64 assembly port of `rssp`.
...
- `include/assp.inc`: NASM constants, ABI layout, and shared macros.
- `include/win64.inc`: Win32 constants used by standalone assembly modules.
- `include/assp.h`: C ABI for external callers and future harnesses.
