...
footswitch smoke cases RSSP emits for `DDL` and `UUL`. Full crossover sequence handling,
timing-aware jack/footswitch coverage, sideswitches, and doublesteps still
require the full parity DP port.
